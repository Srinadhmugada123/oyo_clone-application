...
def register_vendor(request):
    if request.method == "POST":
        ...
        if hotel_user.exists():
            messages.warning(request, "Account exists wuth email or phone number")
        ...
        messages.success(request, "An email send to email")
        return redirect(request, '/account/register-vendor')
